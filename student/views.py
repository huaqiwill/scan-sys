...
from student.management import serializer as ser

from student import models as m_model
from student.models import StudentCourseMemberShip
...
def college_manage(request):
    return render(request, 'student/college_main.html')


def college_add(request):
    return render(request, 'student/college_add.html')
...
def grade_manage(request):
    return render(request, 'student/grade_main.html')


def grade_add(request):
    return render(request, 'student/grade_add.html')
...
def class_manage(request):
    return render(request, 'student/class_main.html')


def class_add(request):
    return render(request, 'student/class_add.html')
...
def course_manage(request):
    return render(request, 'student/course_main.html')


def course_add(request):
    return render(request, 'student/course_add.html')
...
def student_upload_add(request):
    return render(request, 'student/student_upload_add.html')
...
def score_manage(request):
    ...
    return render(request, 'student/score_main.html', context)
...
def banji_score(request):
    return render(request, 'student/banji_score_main.html')
...
def stu_score_manage(request):
    return render(request, 'student/stu_score_main.html')
